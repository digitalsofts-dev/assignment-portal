    ...
    return (
      <div className="min-h-screen bg-slate-100 flex items-center justify-center p-6">
        <div className="bg-white shadow-xl rounded-xl p-8 w-full max-w-md">
          <h1 className="text-2xl font-bold mb-6 text-center">Hiring Dashboard</h1>
          <input
            type="password"
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">Hiring Analytics Dashboard</h1>
        ...
        <div className="grid gap-6 lg:grid-cols-2 mb-8">
          <div className="bg-white rounded-xl shadow p-6">
            <h2 className="font-semibold mb-4">Selected vs Rejected</h2>
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-8">
          <h2 className="font-semibold mb-4">Candidates Per Day</h2>
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <h2 className="font-semibold mb-4">Recent Candidates</h2>
